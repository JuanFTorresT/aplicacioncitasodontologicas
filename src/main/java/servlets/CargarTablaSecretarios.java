 ...
 * @author Felipe
 */
@WebServlet(name = "CargarTablaSecretarios", urlPatterns = {"/CargarTablaSecretarios"})
public class CargarTablaSecretarios extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Secretario> listaSecretarios = (List<Secretario>)controladorSecretario.obtenerListaSecretarios();
