                                        ...
                                        <div>
                                            <div class="p-5">
                                                <div class="text-center">
                                                    <h1 class="h4 text-gray-900 mb-4">Edita un Odontólogo</h1>
                                                </div>
                                                <form class="user" action="ServletOdontologo" method="POST">
                                                    <%
                                                        Odontologo odontologoAEditar = (Odontologo) request.getAttribute("odontologoEditar");
                                                        SimpleDateFormat formatoFecha = new SimpleDateFormat("yyyy-MM-dd");
                                                    %>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-user" name="txtIdentificacionOdonto"
                                                               value="<%=odontologoAEditar.getIdentificacion()%>">
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            <input  type="text" class="form-control form-control-user" name="txtNombreOdonto"
                                                                   value="<%=odontologoAEditar.getNombre()%>">
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control form-control-user" name="txtApellidoOdonto"
                                                                   value="<%=odontologoAEditar.getApellido()%>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="txtDireccionOdonto"
                                                               value="<%=odontologoAEditar.getDireccion()%>">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="number" class="form-control form-control-user" id="exampleInputEmail" name="txtCelularOdonto"
                                                               value="<%=odontologoAEditar.getCelular()%>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Fecha de nacimiento</label>
                                                        <input type="date" class="form-control form-control-user" id="exampleInputEmail" name="fechaNacOdonto"
                                                               value="<%=formatoFecha.format(odontologoAEditar.getFechaNacimiento())%>">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="txtEspecialidadOdonto"
                                                               value="<%=odontologoAEditar.getEspecialidad()%>">
                                                    </div>

                                                    <!-- FORMULARIO HORARIO-->
                                                    <div class="text-center">
                                                        <h1 class="h4 text-gray-900 mb-4">Edita el horario</h1>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Hora Inicio</label>
                                                        <input type="time" class="form-control form-control-user" name="horarioInicio" value="<%=odontologoAEditar.getHorario().getHoraInicio()%>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Hora Fin</label>
                                                        <input type="time" class="form-control form-control-user" name="horarioFin" value="<%=odontologoAEditar.getHorario().getHoraFin()%>">
                                                    </div>

                                                    <!-- FIN FORMULARIO HORARIO-->

                                                    <input type="hidden" id="id" name="idOdontologo" value="<%=odontologoAEditar.getIdPersona()%>">
                                                    <input type="hidden"  name="accion" value="editar">

                                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Editar Odontologo">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
