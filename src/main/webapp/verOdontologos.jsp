            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Odontologos registrados</h1>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="tablaVerOdontologos" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td><%=odontologo.getIdPersona()%></td>
                                                <td><%=odontologo.getIdentificacion()%></td>
                                                <td><%=odontologo.getNombre()%></td>
                                                <td><%=odontologo.getApellido()%></td>
                                                <td><%=odontologo.getCelular()%></td>
                                                <td><%=odontologo.getDireccion()%></td>
                                                <td><%=formatoFecha.format(odontologo.getFechaNacimiento())%></td>
                                                <td><%=odontologo.getEspecialidad()%></td>
                                                <td> De <%=odontologo.getHorario().getHoraInicio()%> a <%=odontologo.getHorario().getHoraFin()%> </td>
                                                <td class="d-flex ">
                                                    <!-- Formulario editar -->
                                                    <form action="ServletOdontologo" method="GET">
                                                        <input type="hidden"  name="idOdontologo" value="<%=odontologo.getIdPersona()%>">
                                                    ...
                                                    <!-- Formulario eliminar -->
                                                    <form action="ServletOdontologo" method="POST">
                                                        <input type="hidden"  name="idOdontologo" value="<%=odontologo.getIdPersona()%>">
